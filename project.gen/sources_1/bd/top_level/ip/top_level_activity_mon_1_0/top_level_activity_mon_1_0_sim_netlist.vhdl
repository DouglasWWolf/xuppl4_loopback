...
--               /fpga/xuppl4_loopback/project.gen/sources_1/bd/top_level/ip/top_level_activity_mon_1_0/top_level_activity_mon_1_0_sim_netlist.vhdl
...
entity top_level_activity_mon_1_0_activity_mon is
  port (
  ...
  attribute ORIG_REF_NAME of top_level_activity_mon_1_0_activity_mon : entity is "activity_mon";
end top_level_activity_mon_1_0_activity_mon;

architecture STRUCTURE of top_level_activity_mon_1_0_activity_mon is
...
entity top_level_activity_mon_1_0 is
  ...
  attribute NotValidForBitStream of top_level_activity_mon_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_level_activity_mon_1_0 : entity is "top_level_activity_mon_1_0,activity_mon,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of top_level_activity_mon_1_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of top_level_activity_mon_1_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_level_activity_mon_1_0 : entity is "activity_mon,Vivado 2021.1";
end top_level_activity_mon_1_0;

architecture STRUCTURE of top_level_activity_mon_1_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF stream, ASSOCIATED_RESET resetn, FREQ_HZ 322265625, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN top_level_cmac_0_gt_txusrclk2, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of stream_tdata : signal is "XIL_INTERFACENAME stream, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 322265625, PHASE 0.0, CLK_DOMAIN top_level_cmac_0_gt_txusrclk2, LAYERED_METADATA undef, INSERT_VIP 0";
begin
inst: entity work.top_level_activity_mon_1_0_activity_mon
     port map (
      active => active,
      clk => clk,
      resetn => resetn,
